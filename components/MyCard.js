/*
 * Brand marks from Font Awesome Free 7.3.1 (https://fontawesome.com), icons
 * licensed CC BY 4.0. Inlined rather than loaded as an icon font: two icons are
 * not worth a stylesheet plus a webfont.
 */
const GitHubIcon = () => (
