	...
	<header>
		...
		<ul className="fa-ul main-list">
			<li className="main-list-item">
				<span className="fa fa-github fa-lg main-list-item-icon" aria-hidden="true"></span>&nbsp;
				<a href="https://github.com/didaquis" target="_blank" rel="noopener noreferrer" title="didaquis on GitHub">Explore my GitHub</a>
			</li>
			<li className="main-list-item">
				<span className="fa fa-linkedin fa-lg main-list-item-icon" aria-hidden="true"></span>&nbsp;
